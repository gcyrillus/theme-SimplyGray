	...
	<form id="form" action="<?php $plxShow->artUrl(); ?>#form" method="post">
		...
		<fieldset>
			...
			<?php if($plxShow->plxMotor->aConf['capcha']): ?>
					<label for="id_rep" style="display:inline"><strong><?php echo $plxShow->lang('ANTISPAM_WARNING') ?></strong>*</label>
					<?php $plxShow->capchaQ(); ?>
			...
			<?php endif; ?>
					...
					<input class="blue m-auto" type="submit" value="<?php $plxShow->lang('SEND') ?>" />
